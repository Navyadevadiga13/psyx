        ...
        <>
            ...
            <div className="reading-container">
                <div className="content-wrapper">
                    ...
                    <button onClick={() => navigate("/")} style={{ background:"#19fd91", color:"black", border:"none", padding:"1.2rem 3rem", fontSize:"1.2rem", fontWeight:"600", borderRadius:"12px", cursor:"pointer" }}>
  Exit Module
</button>
                    </div>
